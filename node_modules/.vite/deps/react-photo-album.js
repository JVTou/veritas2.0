...
function PhotoAlbum({ layout, ...rest }, ref) {
  if (layout === "rows")
    return (0, import_jsx_runtime5.jsx)(RowsPhotoAlbum$1, { ref, ...rest });
  if (layout === "columns")
    return (0, import_jsx_runtime5.jsx)(ColumnsPhotoAlbum$1, { ref, ...rest });
  if (layout === "masonry")
    return (0, import_jsx_runtime5.jsx)(MasonryPhotoAlbum$1, { ref, ...rest });
  return null;
}
...
export {
  ...
  StaticPhotoAlbum$1 as UnstableStaticPhotoAlbum,
